...
<body>
	...
	<div class="navbarmain">
		<div class="navbar" id="myTopnav">
			<a href="index.jsp">Home</a> <a href="board.jsp">자유게시판</a> <a
				href="study.jsp">스터디게시판</a> <a href="data.jsp" class="active">자료실</a>
			<a href="image.jsp">이미지</a> <a href="javascript:void(0);"
	...
	<div class="row">
		<div class="main">
			<div
				style="height: 445px; font-size: 100px; font-weight: bold; padding-left: 30%;">
				<br>자료실 입니다.
			</div>
		</div>
	</div>
