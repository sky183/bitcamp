...
<div class="row">
  ...
  <div class="vertical-menu">
    ...
    <a href="vertical5.jsp"  class="active">스터디 신청</a>
    <a class="bottom">&nbsp;</a>
    <a class="bottom">&nbsp;</a>
    <a class="bottom">&nbsp;</a>
    <a class="bottom">&nbsp;</a>
  ...
  <div class="main">
      <!-- <h2>제목</h2> -->
      <!-- <h5>2018년 8월 8일</h5> -->
      <div style="height:200px; width: 900px; color: blue; font-size: 100px; font-weight: bold; padding-left: 60px;"><br>5페이지입니다.</div>
      <br>
  </div>
</div>
